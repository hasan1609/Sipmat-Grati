...
class KebisinganController extends Controller
{
    ...
    public function updatekebisingan(Request $request)
    {
        ...
        $edit = DB::table('kebisingans')->where('id',$request->id)->update($data);
        $response = [
            'message' => 'Post apar berhasil',
            'sukses' => 1,
            'data' =>null
    ...
    public function deletekebisingan(Request $request)
    {
        ...
        DB::table('kebisingans')->where('id',$request->id)->delete();
        $response = [
