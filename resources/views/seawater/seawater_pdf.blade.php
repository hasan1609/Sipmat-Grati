...
<body>
    ...
    <table class="tg">
        ...
        <tr>
            ...
            <th class="tg-9o1m" colspan="4">{{ $seawater->tanggal_pemeriksa }}</th>
        </tr>
        <tr>
        ...
        <tr>
            <td class="tg-73a0">Battery I / II AMPERE</td>
            <td class="tg-9o1m">4</td>
            <td class="tg-9o1m">A</td>
            <td class="tg-73a0" colspan="2">{{ $seawater->de_battery_ampere_sebelum_start }}</td>
            <td class="tg-73a0">{{ $seawater->de_battery_ampere_sesudah_start }}</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="tg-73a0" colspan="2">
                {{ $seawater->de_cooling_water_pressure_after_regulator_sebelum_start }}</td>
        ...
        <tr>
            <td class="tg-73a0" colspan="8" rowspan="8"><span style="font-weight:bold"> Keterangan : </span> L
                : Low N : Normal H : Hight F : Full <br> <br> Catatan : {{ $seawater->catatan }} </td>
        </tr>
        <tr>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="tg-f4iu"><img src="{{ public_path('storage/' . $seawater->k3_ttd) }}" alt=""
                    style="width:100px ; height:100px"><br><br><br></td>
            <td class="tg-f4iu" colspan="3"><img src="{{ public_path('storage/' . $seawater->operator_ttd) }}"
                    style="width:100px ; height:100px" alt=""></td>
            <td class="tg-f4iu" colspan="2"><img src="{{ public_path('storage/' . $seawater->supervisor_ttd) }}"
                    style="width:100px ; height:100px" alt=""></td>
        </tr>
        <tr>
